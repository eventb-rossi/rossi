...
pub fn check_machine(
    ...
    // empty stub is byte-exact against every `dcmp_*.bcm` in the corpus
    ...
    for name in &unresolved {
        ...
        // (`tutorial_contract-annotations/AM1.bcm`).
        diags.push(Diagnostic {
    ...
    // variable mark itself `accurate="false"` (see
    // `tutorial_contract-annotations/AM1.bcm`). An event whose
