...
//!
//! Sources: `etcs_s313` corpus model has 15 such machines; their
...
fn emits_attribute_only_stub() {
    let body = r#"<org.eventb.core.variable name="_v" org.eventb.core.identifier="A_gradient"/>
<org.eventb.core.invariant name="_i" org.eventb.core.label="typ" org.eventb.core.predicate="A_gradient ∈ ℤ" org.eventb.core.theorem="true"/>
...
<org.eventb.core.action name="_a1" org.eventb.core.assignment="A_gradient ≔ 0" org.eventb.core.label="act1"/>
</org.eventb.core.event>
"#;
    let project = Project::new("etcs_like", vec![stub_machine("dcmp_m0", body)]);
    let r = build(&project);

    let bcm = r.file("dcmp_m0.bcm").expect("dcmp_m0.bcm");
    let expected = format!(
...
fn refinement_chain_of_stubs_does_not_crash() {
    // Mirrors etcs_s313: dcmp_acceleration_gradient_m1 refines
    // dcmp_acceleration_gradient_m0. Both are decomposition stubs.
    let m0 = stub_machine("dcmp_m0", "");
    let m1_body = r#"<org.eventb.core.refinesMachine name="_ref" org.eventb.core.target="dcmp_m0"/>
"#;
    let m1 = stub_machine("dcmp_m1", m1_body);
    let project = Project::new("etcs_like", vec![m0, m1]);
    let r = build(&project);
