...
//! Rodin parity — verified against `ca648.zip/Buffer_r.bcm` and
//! `ca648.zip/Stack_r.bcm`, where the refining machine's INITIALISATION
//! witnesses the disappearing abstract variable (`element'`).
