...
- On save, the full `rossi validate` runs over the project, adding the project
  lints and proof status the live server does not report. Turn it off with
  `rossi.validate.onSave`.
